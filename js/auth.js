...
const ROLE_PAGES = {
  admin:   ['cotizador', 'trabajos', 'inventario', 'configuracion', 'usuarios', 'dashboard', 'clientes', 'detalle', 'costos', 'calendario'],
  usuario: ['cotizador', 'trabajos', 'dashboard', 'clientes', 'detalle', 'calendario']
};
